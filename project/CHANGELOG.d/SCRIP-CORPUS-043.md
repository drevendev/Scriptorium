...
- Replayed all 410 previously frozen 1928 *The Twelve Chairs* Page revisions with exact title/timestamp/MediaWiki SHA-1 checks before transient wikitext inspection.
- Added a candidate-specific source-free markup-surface auditor plus compact durable freeze; no Page wikitext, template argument values, OCR, rendered prose, scan bytes or literary text are committed.
