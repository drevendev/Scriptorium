...
LAST_COMMITTED_RUN_AT: 2026-09-22T10:50:00Z
LAST_RESULT: SCRIP-CORPUS-058 / Issue #203 completed. Independent exact-head review `5277004834` re-read PR #204 at `31e24f05beb736c7ae504ebdd3c1510c5f8cfda4` against unchanged `master@063c38fa97215153f43194158c774d6a825c41ad`, reviewed all 8 changed files, found no merge blocker or open review thread, independently reproduced the recorded dialogue ratios, freshly rechecked FantLab work 27344, and confirmed all 17 PR-triggered workflow runs settled `success`. PR #204 was marked Ready and squash-merged with expected-head protection as `90aa67295e7858a7df46a7cab8b6aac769934a9c`, closing Issue #203 completed.
LAST_VERIFIED_PROGRESS: The source-free exact-body dialogue-policy diagnostic is now canonical on master for the frozen 363,819-character *Running on Waves* body / SHA-256 `41a1ada3caabea2909976372ca6312fb8a478f2d0d87c088f304fcb30c52fdbc`. It records 736 dialogue paragraphs, 1,215 internal separators, 706 current-v1 author-remark spans and 571 punctuation-shaped author-remark spans. Current-v1 remarks are 34.563165459722235% of detected dialogue non-whitespace but 12.4046723291002% of total non-whitespace, only 0.08532767089980098 pp below FantLab's displayed 12.49%. This remains a high-value denominator hypothesis only: FantLab analyzer-input identity is unknown, production `scriptorium-dialogue-v1` is unchanged, `gate_ready=false`, `m2_parity_admissible=false`, and M2 remains 0/5.
...
STATUS:         COMPLETE
PR:             #204 (independently reviewed; squash-merged as 90aa67295e7858a7df46a7cab8b6aac769934a9c)
NEXT_ACTION:    Resume normal-flow selection from the queue. Retain the total-text denominator result as a high-value
                follow-up hypothesis, but do not change production dialogue semantics or promote parity without
                source-matched or multi-work evidence.
```
...
- **Running on Waves** — SCRIP-CORPUS-028 froze the Detskaya literatura 1965 family at 36 literary pages, 363,819 characters / 656,239 bytes, SHA-256 `41a1ada3caabea2909976372ca6312fb8a478f2d0d87c088f304fcb30c52fdbc`, clearing >=300k. SCRIP-CORPUS-057 is independently reviewed and complete on master with a source-free 27-row exact-body deterministic diagnostic against FantLab work 27344. SCRIP-CORPUS-058 is independently reviewed and complete on master with a separate source-free exact-body dialogue-policy sensitivity artifact: current-v1 author remarks are 34.563165459722235% of dialogue non-whitespace but 12.4046723291002% of total non-whitespace, only 0.08532767089980098 pp below FantLab's displayed 12.49%. This is a denominator hypothesis, not recovered semantics. FantLab source match remains unknown, gate/M2 remain closed, and the separate 1980 route stays distinct.
