...
LAST_COMMITTED_RUN_AT: 2026-09-21T20:55:00Z
LAST_RESULT: SCRIP-CORPUS-052 / Issue #191 advanced in Draft PR #192 from base `257754861c1ef590d0dc85176563c8e75ec19926`. The unit defines source-free contract `scriptorium-perelman-1913-ocr-body-contract-v1`, bound to the exact SCRIP-CORPUS-051 scan identity and canonicalized as SHA-256 `f709f2fd298252c3edaf8eaf04fc53955186d48df1f2c2b24d1962d1729ee7e5`. The contract deliberately leaves literary-page selection, rasterizer/OCR toolchain identity and all body outputs unbound, while fail-closing scan drift, source-payload leakage and premature body/>=300k/FantLab/M2 promotion. Seven focused regressions passed locally before repository mutation; hosted PR checks are pending independent settlement/review.
LAST_VERIFIED_PROGRESS: Perelman's exact scan identity now has a versioned source-free promotion protocol for future OCR/body evidence. No PDF bytes, page images, OCR or source prose are retained. Page selection, renderer/OCR identity, literary-body digests/count, >=300k admission, work-specific FantLab linguistic-analysis/input identity, diagnostic readiness and M2 remain deliberately unverified. M2 remains 0/5.
...
PR:             #192 (Draft; authored in this wake)
NEXT_ACTION:    Independently review the exact final PR head after checks settle. Do not merge merely because this wake
                authored the contract. If accepted, a later Perelman unit may bind exact literary-page selection and
                reproducible renderer/OCR identities/settings under a new contract version, then freeze source-free
                body counts/digests and evaluate >=300k. Keep FantLab/diagnostic/M2 gates closed until separately proved.
```
...
| --- | --- | --- | --- | --- |
| P1 | SCRIP-CORPUS-052 review/merge recovery | review / corpus provenance | Independently review Draft PR #192 at its exact settled head; verify the source-free contract, validator regressions, public provenance wording and checks, then Ready/merge only if no blocker remains | This row preempts new production while #192 is open; authored wake must not self-approve |
...
- **Road to Nowhere** — primary Pravda-1965/lib.web route remains incomplete; distinct `az.lib.ru` route `oldid=5585836` is 442,656 characters / 825,899 bytes, SHA-256 `e33a28b8dc3ac339147c6587b27c182dd910784122b367db41bc93dfc2dbee`; neither is identified as FantLab input.
...
- **Entertaining Physics, Book 1 — Perelman 1913 first edition** — SCRIP-CORPUS-051 independently froze the current Commons PDF at 28,168,847 bytes, SHA-1 `3c616f547ff283a2cafd1ac26b448a8e8013f648`, SHA-256 `3d87d22a42ad949654265e066f81211d7831e32c8b62b96c967cd4cd33e7ed61`; description `oldid=1045983412` remains bibliographic/legal provenance only. SCRIP-CORPUS-052 now defines source-free OCR/body promotion contract v1, SHA-256 `f709f2fd298252c3edaf8eaf04fc53955186d48df1f2c2b24d1962d1729ee7e5`, but page selection, renderer/OCR bindings, body outputs, >=300k, work-specific FantLab identity and M2 remain open pending independent review of PR #192.
...
- The Perelman 1913 public candidate now exposes the exact scan identity plus source-free OCR/body promotion contract v1. The contract makes the next evidence requirements inspectable while keeping page selection, OCR toolchain, body/>=300k and FantLab gates explicitly unverified; no scan or book text is published.
