...
LAST_COMMITTED_RUN_AT: 2026-09-18T06:09:00Z
LAST_RESULT: SCRIP-CORPUS-020 / Issue #109 advanced through Draft PR #122 with a source-free candidate-specific resolution of the exact target-only Part 2 source graph. The authored replay expands the six frozen `poemx1` calls under the already-frozen frame/control/render surface, freezes the expanded dependency at 585,113 characters / 1,059,957 bytes (SHA-256 `a027dfe0d867572f3802050fcfd72b07a43fa6efe539d58035b3af59f49a04d4`), and freezes the resolved Part 2 parent wikitext after exact target-only substitution at 1,166,949 characters / 2,114,262 bytes (SHA-256 `ab45577f567ce504e24936f73fcdff261780168414e4bccc04bbf8927299d016`). Historical Russian Wikisource MediaWiki/Poem deployment equivalence, literary-body extraction/composition and FantLab source equivalence remain unresolved.
LAST_VERIFIED_PROGRESS: Exact authored head `cadbd2f812468c468f41a322965672b328cfbf65` completed all 11 triggered workflows successfully. Dedicated Part 2 replay `35313433442` checked out that exact SHA, ran the complete 239-test standard-library suite, re-fetched parent oldid `5198033`, target dependency oldid `2366546`, and inferred `Шаблон:Poemx1` oldid `5142743`, regenerated the source-free resolution artifact and byte-compared it against the committed JSON successfully. The pinned-pylem workflow also completed all three jobs successfully. All six full template expansions reach exactly `#if` x4, `#ifeq` x3 and `#tag` x1 while `#expr` / `#iferror` remain unreachable; each reached Poem digest matches the previous frozen render evidence. The expanded dependency retains zero `poemx1` calls and zero `{{` / `}}` expansion delimiters. PR #122 remains Draft for independent later-run judgement; M2 remains 0/5.
...
ISSUE:          #109
STATUS:         PART2_RESOLUTION_AUTHORED_REVIEW_REQUIRED
PR:             #122 (draft)
MERGED_COMMIT:  —
NEXT_ACTION:    Independently review the exact final head of Draft PR #122 and its checks; if clean, mark Ready and merge.
                After merge, define fail-closed per-part literary extraction and deterministic 1 -> 2 -> 3 -> 4
                composition before recording raw or `scriptorium-text-v1` composite literary-body digests.
```
...
| --- | --- | --- | --- | --- |
| P0 | SCRIP-CORPUS-020 continuation | corpus / provenance | Independently review/merge Draft PR #122; after merge define deterministic fail-closed per-part literary extraction and 1 -> 2 -> 3 -> 4 composition | Part 2 resolution is authored source-free in #122; historical Wikisource core/Poem deployment equivalence remains unproven; literary-body identity remains unfrozen |
...
- **Brothers Karamazov** — frozen public-source candidate: 98 admitted revisions; composite 1,810,351 characters; SHA-256 `26b9991c95b30d262c24ae38fb2333a58df588a62a4310f9e5c4b507dbce6`; FantLab source match unknown.
...
- **The Life of Klim Samgin** — four exact Russian Wikisource parent revisions are replay-frozen at oldids `5733765`, `5198033`, `5138882`, `5724453`; ordered parent revision-wikitext identity SHA-256 `54beabd28d8459bc6a0f1d83187dca56067e337999688d32c809d34340105577`, totaling 3,228,790 parent wikitext characters / 5,902,920 UTF-8 bytes. Part 2's target dependency is replay-frozen at oldid `2366546`, and merged PRs #111–#121 freeze the target-only `#lst` semantics, inferred historical `poemx1` revision, inclusion controls, literal parameter surface, six concrete invocation bindings, reachable `#if`/`#ifeq` graph, exact parameter-2 values, inferred Poem implementation anchor, reached one-content/zero-attribute `#tag:poem`, and candidate-specific plain-value MediaWiki/Poem render surface. Draft PR #122 now authors the next source-free layer: the expanded target dependency is 585,113 characters / 1,059,957 bytes with SHA-256 `a027dfe0d867572f3802050fcfd72b07a43fa6efe539d58035b3af59f49a04d4`, and exact target-only substitution yields resolved parent Part 2 wikitext 1,166,949 characters / 2,114,262 bytes with SHA-256 `ab45577f567ce504e24936f73fcdff261780168414e4bccc04bbf8927299d016`. This remains candidate-specific inferred reconstruction pending independent review/merge; exact historical MediaWiki/Poem deployment, literary extraction/composition and FantLab source identity remain unresolved.
...
- SCRIP-CORPUS-020 progressively exposed the Klim Part 2 dependency, exact target-only `#lst`, inferred `poemx1` anchor, post-inclusion dependency and parameter surfaces, concrete invocation bindings, control reachability, exact parameter-2 surface, inferred Poem implementation anchor, reached extension-call shape and bounded render surface. Draft PR #122 now extends the public candidate page with the source-free resolved Part 2 wikitext identities while keeping literary-body extraction/composition and historical deployment equivalence explicit unresolved boundaries.
...
9. Klim Samgin's source graph through the candidate-specific Part 2 expansion is now authored source-free in Draft PR #122. The exact historical Russian Wikisource MediaWiki-core and Poem deployment revisions remain unproven, so historical render equivalence must not be inferred. The resolved Part 2 identity is wikitext/source-graph evidence, not a literary-body identity; per-part fail-closed extraction, deterministic four-part composition and composite raw/normalized body digests remain unfrozen until a later unit.
