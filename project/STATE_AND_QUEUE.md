...
LAST_COMMITTED_RUN_AT: 2026-09-19T22:52:00Z
LAST_RESULT: SCRIP-CORPUS-034 / Issue #155 completed after independent exact-head review of PR #156. Exact authored head `dd1cd6083e44cd4bfeac8df932a50721a3e41cad` remained mergeable against unchanged base `3aa62c1dac2a9f7b4b4449d753226267eed61160`, 17 commits ahead / 0 behind, with no inline review threads. All 15 changed paths were inspected and no literary source prose, OCR, rendered Page payload, scan bytes or downstream-gate promotion was found. All 15 pull-request-triggered workflows completed successfully. `Darwin Rachinsky Page revision identities` run `35472282171`, job `105975295568`, checked out the exact reviewed SHA, ran 293 tests successfully and replayed all 418 pinned Page revisions with `identity_replay_match=true`; artifact `10593275396` is 538 bytes with SHA-256 `82008b4c69a7c4d65f874d5595a6494405ba527c9f0fe5d2091f311c91c9ef9a`. PR #156 was marked Ready and squash-merged as `a8429d82a33e3a0e2606c72a398343b00d604da8`; Issue #155 closed completed.
LAST_VERIFIED_PROGRESS: `darwin-origin-species-rachinsky-1864-ru` now canonically retains `rendered_route_graph_proofreadpage_topology_and_418_page_revision_identities_frozen_literary_body_unfrozen` provenance in `master`. Exact revision ID, timestamp and MediaWiki SHA-1 are frozen for all 418 included Page sequences in four SHA-256-pinned source-free shards plus an authoritative index; source-declared no-text sequences 114 and 411 remain excluded. No wikitext/OCR/rendered prose/scan bytes are committed. Independent scan bytes/SHA-256, candidate-specific fail-closed literary-body extraction/composition, body count/digests and >=300k admission remain unfrozen/false. FantLab still exposes Timiryazev rather than Rachinsky and M2 remains 0/5.
...
MERGED_COMMIT:  a8429d82a33e3a0e2606c72a398343b00d604da8
NEXT_ACTION:    Resume normal-flow P2 corpus/provenance work. For Darwin/Rachinsky, the next evidence-bearing strengthening
                is a candidate-specific fail-closed literary-body extraction/composition contract over the frozen 418 Page
                identities; body count/digests and >=300k admission remain separate gates and must be independently proved.
```
...
- **On the Origin of Species — Rachinsky translation** — SCRIP-CORPUS-034 is complete. Merged PR #156 canonically retains parent `oldid=5628021`, ProofreadPage index `oldid=4494408`, 15 rendered routes, shared route-template `oldid=3775868`, parent topology witness `oldid=5712882`, 399 route plus 19 parent dependencies, exact no-text exclusions 114/411, and exact revision ID/timestamp/MediaWiki SHA-1 for all 418 included Page dependencies in four digest-pinned source-free shards with exact-revision replay. Literary-body extraction/composition, body count/digests, independent scan bytes/SHA-256 and >=300k admission remain unfrozen, so `admitted_for_calibration=false`. FantLab work 969964 currently exposes Timiryazev rather than Rachinsky; source match/M2 remain unknown/zero.
...
- Merged SCRIP-CORPUS-034 makes Darwin/Rachinsky's complete source-free 418-Page revision identity inventory canonical and inspectable as four SHA-256-pinned shards plus an authoritative index and public candidate explanation. No Page prose/scan bytes are published; literary-body >=300k and FantLab/M2 gates remain visibly closed.
...
14. Darwin/Rachinsky 1864 now has a canonical exact 418-Page revision-identity freeze in `master`, but literary-body extraction/composition, body count/digests, independent scan-byte/SHA-256 identity and >=300k admission remain unresolved; FantLab's current Russian translation surface is a different translation.
