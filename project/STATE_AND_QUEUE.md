...
LAST_COMMITTED_RUN_AT: 2026-09-20T17:58:00Z
LAST_RESULT: SCRIP-CORPUS-043 / Issue #173 authored in Draft PR #174 from master `3fea17457b295f5307bc5a4d2e4635ffb7a81ce5`. The unit adds a candidate-specific fail-closed markup-surface auditor over all 410 already-pinned 1928 *Twelve Chairs* Page revisions, a compact durable source-free freeze, deterministic tests, and hosted exact-revision replay. Initial hosted run `35527395084`, job `106121837144`, succeeded on authored head `ee1c912eacf9377a3085f4d1e2cf057d2bf07e9b`, replaying all 410 exact revisions and producing source-free artifact `10609958469` (33,926-byte ZIP, SHA-256 `ee26cf53526f352eadf5c8ce612b3befda6e82694e47ac5dfda3f1f5f4e74af9`). The durable freeze binds source index SHA-256 `c1e3280984e640b8fe739a752ff49a3327633f49b52a635bd2d2d1e6a09f538f`, 410 transient Page receipts digest `2d4483b7296cfcc18288816f8d4c3bde2e71750808e1d57be932768a1e82c6f2`, and freeze manifest SHA-256 `8a4f04238c68c40e59464e76a7911f0bee9488e09daab9f8772b1af970768d23`. Later commits added the compact freeze, comparison tests, public candidate synchronization and durable bookkeeping; PR #174 remains Draft for an independent later exact-head review.
LAST_VERIFIED_PROGRESS: The SCRIP-CORPUS-043 branch now source-freezes the exact construct surface seen across the same 410 pinned 1928 *Twelve Chairs* Page dependencies while keeping the reviewed gap exclusion unchanged. Hosted replay verifies exact title/timestamp/MediaWiki SHA-1 identities before transient wikitext inspection; only template/tag shapes, aggregate counts and cryptographic Page receipts are retained. No Page wikitext, template argument values, OCR, rendered prose, scan bytes or literary text are committed. Rendering semantics, inter-page composition/separators, literary-body count/digests, Scriptorium-proven >=300k admission and FantLab analyzer-input/source-edition identity remain unfrozen/unknown; diagnostic readiness is false and M2 remains 0/5.

## Current unit

```text
UNIT_ID:        SCRIP-CORPUS-043
ISSUE:          #173 (open)
STATUS:         REVIEW_PENDING
PR:             #174 (Draft)
NEXT_ACTION:    Independently re-orient from master and Draft PR #174, review the exact final authored head against base
                3fea17457b295f5307bc5a4d2e4635ffb7a81ce5, confirm the dedicated exact-410 replay/freeze workflow and required
                repository workflows have settled successfully, inspect the source-free freeze and public boundary, and only then
                decide Ready/merge. Do not self-approve merely because the previous wake authored the change. If merged, reconcile
                Issue #173 plus state/changelog to master before selecting another unit.
```
...
- **The Twelve Chairs** — SCRIP-CORPUS-043 is REVIEW_PENDING in Draft PR #174. The distinct 41-chapter 1928 first-standalone family retains the independently reviewed parent route graph, all 410 exact Page dependency identities, exact source-free backing Commons PDF identity (77,978,350 bytes; SHA-1 `4ab6aa42c3517169e99c1177b6fb6412cfe9187d`; SHA-256 `5a82f8101f9c17dfafcf8b45dc9ed5a7cdfa12a3e88d18bd0f0987e4fcd51eb4`), reviewed source-free four-gap audit, and independently reviewed composition-membership decision. The draft unit adds a source-free exact-410 markup-surface inventory bound to the existing Page index; hosted replay succeeded before the durable freeze was added, and the final exact head still requires independent review. All four audited gaps remain excluded from the canonical-route composition surface; 150/314 remain `nonempty_body_unclassified`, 151/315 retain `no_transcluded_body`. Page rendering semantics, inter-page composition/separators, literary-body counts/digests and Scriptorium-proven >=300k admission remain unfrozen. The 40-chapter later 1938/1961 editorial family stays distinct; coauthorship prevents individual-author attribution without an explicit VOICE model.
- **The Life of Klim Samgin** — SCRIP-CORPUS-020 is complete. Four exact parent revisions and the Part 2 dependency are replay-frozen; merged PRs #111–#124 freeze the target-only `#lst`, inferred `poemx1`/Poem boundaries, structural surface and all thirteen plain literary values; #126 merged the candidate-specific fail-closed extractor; #127 merged the canonical source-free per-part/composite literary-body identities; #128 reconciled the structured provenance trace. Exact historical MediaWiki/Poem deployment and FantLab analyzer-input/source-edition identity remain unresolved.
...
- Merged SCRIP-CORPUS-038 exposes a dedicated Petersburg 1916 candidate page and `corpus/README.md` navigation with the independently reviewed exact source-free PDF byte identity plus 1916/1922 edition boundary while explicitly keeping OCR/body/admission/FantLab gates open.
...
- Draft SCRIP-CORPUS-043 extends the dedicated 1928 *Twelve Chairs* candidate page with the source-free exact-410 markup-surface freeze while explicitly distinguishing construct inventory from renderer semantics and keeping composition/body/admission/FantLab gates closed.
...
13. The 1928 *Twelve Chairs* route has independently reviewed exact source-free identities for all 410 referenced Page dependencies, exact backing Commons PDF identity, merged four-gap evidence and reviewed gap composition membership. Draft SCRIP-CORPUS-043 now adds an exact-410 source-free markup-surface inventory, but renderer semantics, inter-page composition/separators, literary-body counts/digests and FantLab source identity remain unresolved and the draft itself still requires independent exact-head review.
