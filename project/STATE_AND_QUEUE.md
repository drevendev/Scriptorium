...
- SCRIP-CORPUS-006 established the Moscow Goslitizdat 1958 collected-works volume 4 as a concrete but collateral edition lead from sibling Wikisource/az.lib provenance plus independent FantLab bibliography.
- SCRIP-CORPUS-007 strengthens only the **textual-family classification** of that lead: FantLab-hosted Yu. A. Krestinsky commentary distinguishes four book editions and states that the Moscow 1958 volume's Hyperboloid text is printed from the 1939 fourth book edition with checking against preceding editions. Russian State Library record `01006486636` separately catalogs a Kyiv 1958 Hyperboloid/Aelita edition, proving that year-only `1958` matching is ambiguous.
- Neither finding directly ties the Wikisource/az.lib transcription to the Moscow volume. `bibliographic_source_identity` therefore remains unset; the lead is a 1939-derived textual-family target with no source/parity weight.
...
10. Hyperboloid of Engineer Garin has a permanent public-domain Wikisource revision and a concrete Moscow Goslitizdat 1958 lead now classified as a 1939-fourth-edition-derived textual-family witness. It still has no frozen literary-text identity, no direct bibliographic statement tying the Wikisource/az.lib transcription to that Moscow volume, and no evidence tying FantLab's 2022 input to it; a distinct Kyiv 1958 edition also makes year-only matching explicitly unsafe. Diagnostics and M2 remain disabled.
