"""Freeze a fail-closed Page-rendering decision profile for Darwin/Rachinsky 1864.

The profile consumes only the committed source-free exact-388 rendering-surface freeze.
It classifies every observed tag/template shape and deliberately refuses to invent
Wikisource template, reference or math expansion semantics. This is a profile boundary,
not a renderer: page prose, inter-page composition, body counts/digests and corpus/
FantLab gates stay closed until unresolved semantic classes are independently frozen.
"""
...
from .darwin_render_surface_freeze import validate_freeze_manifest

PROFILE_VERSION = "scriptorium-darwin-page-render-profile-v1"
PROFILE_STATUS = "fail_closed_profile_frozen_template_reference_math_semantics_pending"
CANDIDATE_ID = "darwin-origin-species-rachinsky-1864-ru"
SURFACE_SCHEMA = "scriptorium-darwin-render-surface-freeze-v1"
SURFACE_STATUS = "surface_inventory_frozen_renderer_unfrozen"
EXPECTED_DEPENDENCY_COUNT = 388
EXPECTED_INDEX_SHA256 = "a1b1011095dc84ab0a5cd3ef45b2a46ce99588a0ef9cf507c1f711c925ba86dd"
EXPECTED_SURFACE_FREEZE_SHA256 = "e5ae625fef6afb2e890de990e1ef3b9e108a409a2e0ea2136947c2c3e1cea44d"

TAG_DECISIONS: dict[tuple[str, str], tuple[str, str]] = {
    ("big", "close"): ("preserve_inner_text_container", "defined"),
    ("big", "open"): ("preserve_inner_text_container", "defined"),
    ("div", "close"): ("preserve_inner_text_container", "defined"),
    ("div", "open"): ("preserve_inner_text_container", "defined"),
    ("math", "close"): ("provider_math_semantics_required", "unresolved"),
    ("math", "open"): ("provider_math_semantics_required", "unresolved"),
    ...
    ("ref", "close"): ("provider_reference_semantics_required", "unresolved"),
    ("ref", "open"): ("provider_reference_semantics_required", "unresolved"),
    ("references", "self_closing"): ("provider_reference_semantics_required", "unresolved"),
    ("small", "close"): ("preserve_inner_text_container", "defined"),
    ("small", "open"): ("preserve_inner_text_container", "defined"),
    ("sub", "close"): ("preserve_inner_text_container", "defined"),
    ("sub", "open"): ("preserve_inner_text_container", "defined"),
    ("sup", "close"): ("preserve_inner_text_container", "defined"),
    ("sup", "open"): ("preserve_inner_text_container", "defined"),
}
...
def _validate_surface_identity(surface: Mapping[str, object]) -> None:
    ...
    expected = {
        ...
        "literary_dependency_count": EXPECTED_DEPENDENCY_COUNT,
...
def build_profile(surface: Mapping[str, object]) -> dict[str, object]:
    ...
    profile: dict[str, object] = {
        ...
        "extraction_policy": {
            ...
            "math_policy": "do_not_guess; freeze provider math-to-text semantics before literary-body rendering",
            "reference_policy": "do_not_guess; freeze provider reference inclusion/placement semantics before literary-body rendering",
...
def validate_profile(profile: Mapping[str, object], surface: Mapping[str, object]) -> None:
    ...
    if dict(profile) != expected:
        raise ValueError("Darwin/Rachinsky rendering profile drift")
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    print(json.dumps({
        ...
        "unresolved_tag_shape_count": profile["coverage"]["unresolved_tag_shape_count"],
    }, sort_keys=True))
    return 0
